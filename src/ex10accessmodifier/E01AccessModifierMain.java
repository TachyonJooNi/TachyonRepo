...
//		one.privateMethod();//에러발생
		...
		*/
		System.out.println("DefailtClass 객체 생성 및 접근");
...
//		System.out.println("two.defaulVar="+ two.defaultVar);//에러발생
