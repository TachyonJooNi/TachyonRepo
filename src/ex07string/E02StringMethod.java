...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		*/
		System.out.println("str1의길이:"+ str1.length()); //str1의길이:14 출력
		System.out.println("str2의길이:".length() + str2.length()); //15 출력
		System.out.println("오늘은좋은날".length()); //6 출력
		System.out.println("==========================================");
		...
		*/
		System.out.println("str1의 두번째 문자:"+ str1.charAt(1));//e 출력
		System.out.println("str2의 두번째 문자:"+ str2.charAt(1));//바 출력
		System.out.println("==========================================");
		
		/*
		시나리오] 주민등록번호를 이용하여 성별을 판단하는
		프로그램을 작성하시오.
		190419-3000000 => 남자(1 또는 3)
		190419-4000000 => 여자(2 또는 4)
		*/
		String juminNum = "190419-5000000";
		/*
		앞에서 주어진 문자열의 8번째 문자. 즉, 인덱스 7번은 성별에 해당하는 문자이다.
...
//		String email1 = "not@naver";
		...
		8] startWith()
			...
			(http로 시작해서 작성해주세요 라고 요청하고 잘 작성했는데 확인할수있다.)
		*/
		...
		*/
		...
		//문자열을 서식에 맞춰 만든후에 반환한다. 이를 콘솔이 아닌 웹브라우저에 전달해 출력할 수 있다.
		//String.format()으로 앞에 String을 두고 쓴다.
		...
		10] indexOf()
			...
			만약 없다면 -1을 반환한다.
		*/
		//초기값잡을때 덧셈:0, 곱셈:1, 배열:-1로 잡는게 일반적이다.
		...
		*/
		...
		System.out.println("indexOf:"+ str1.indexOf("a"));//11(앞에 있는 a의 인덱스)
		System.out.println("lastIndexOf:"+ str1.lastIndexOf("a"));//13(마지막 a)
		System.out.println("==========================================");
