...
/*
FruitSalesMain 첫번째 버전은 각 클래스가 멤버변수의 초기값이 고정되어
...
class FruitBuyer2 {
	...
	//멤버변수의 초기값을 제거한 후 초기화 메서드를 통해 초기화한다.
	int myMoney;
	int numOfApple;
	public void initMembers(int _myMoney, int _numOfAppler) {
		myMoney = _myMoney;
