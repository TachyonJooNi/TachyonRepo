...
public class E05Date {
	...
	/*
	Calendar클래스를 통해 얻은 객체를 초로 변환한 후 매개변수로 전달된
	...
	*/
	...
	public static void main(String[] args) {
		...
		*/
		...
		String nowStr3 = myDateFormat(calendar, "yyyy년 MM원 dd일");
...
//			System.out.println(formatToday+" "+formatFuture);
			...
			11~13저라눈 밀리세컨즈를 의마한다.
			즉 1000으로 나눠서 뒤의 3자리를 제거하면 순수한 초가 반환된다.
			또한 하루는 24*60*60=86400초 이므로 아래와 같이 남은 날짜를 구할수 있다.
			*/
