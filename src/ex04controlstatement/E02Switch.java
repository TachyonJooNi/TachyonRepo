...
public class E02Switch {
	...
	public static void main(String[] args) {
		...
		Scanner클래스
			...
			메서드가 실행되면 잠깐 실행이 중지되고 입력을 기다리게된다.
			nextLine() : 문자열을 입력받는 메서드
			nextInt() : 정수를 입력받는 메서드
			메서드가 더 있지만 위 두가지 말고는 잘 안씀.
		*/
...
//			break;//switch문의 마지막에는 break문을 기술할 이유가 없다. 어쩌피 나가니까
		}
		...
		(대부분의 경우에는 int, String만 사용한다)
		*/
//		long ln = 100;
//		switch(ln) { //==> 에러발생. long타입 사용불가
//		case 100:
...
//		}
		...
		String title = "자바";
		 switch(title) {
		 case "자바": System.out.println("자바 졸아");
		 	break;
