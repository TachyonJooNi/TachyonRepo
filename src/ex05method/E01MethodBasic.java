...
public class E01MethodBasic {
	...
	/*
	메서드정의1 : 반환형 O, 매개변수 O 형태로 정의
		=> 두개의 정수를 전달받아 합의 결과를 반환한다.
	*/
	public static int simpleFunc(int a, int b) {
		int sum = a + b;
		// 0.1 추가하면 int니까 에러 -> double로 바꿔도 메서드 반환타입이 int이니 에러
//		double sum = a + b + 0.1;
		return sum;
	}
	
	/*
	메서드정의2 : 반환형 X, 매개변수 X 형태로 정의
	...
	*/
	public static void main(String[] args) {
		...
		System.out.println("1과2를 전달하는 결과"+ result);
		System.out.println("10과20을 전달하는 결과"+ simpleFunc(10, 20));
