...
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		아래와 같이 2차워배열을 초기화하면 세로(행)3, 가로(열)4인 배열이
		...
		*/
		...
		int[] arr2 = new int[5];
		arr2[0] = 1;
		System.out.println("arr2 배열명 출력:"+ arr2);//1차원배열에서 배열명은 주소값을 출력
		System.out.println("arr2[0] 원소 출력"+ arr2[0]);//하나의 인덱스기호를 사용했을때는 배열의 원소를 출력
