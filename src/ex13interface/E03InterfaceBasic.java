...
-인터페이스는 생성자가 없다. (추상클래스는 생성자있음)
*/
interface MyInnterface1 {
...
/*
인터페이스는 콤마(,)를 이용해서 여러개를 동시에 '구현' 할 수 있다.
또한 '상속'과 '구현'을 동시에 사용할수도 있다.
*/
class MyClass extends SimpleClass implements MyInnterface1, MyInterface2{
	/*
...
public class E03InterfaceBasic {
	...
	public static void main(String[] args) {
		...
		MyInnterface1 my1 = new MyClass();
		my1.absFunc1();
		my1.absFunc2();
		//자식쪽 멤버에 접근하기 위해 다운캐스팅 후 호출한다.
		((SimpleClass)my1).mySumple();
