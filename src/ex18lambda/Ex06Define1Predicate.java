...
public class Ex06Define1Predicate {
	...
	public static void main(String[] args) {
		...
		*/
		...
		남자인 경우 true를 여자인 경우 false를 반환한게 될것이다.
		*/
		Predicate<Human> pre = (Human h) -> {
			//Human객체의 getter()를 통해 멤버변수값을 가져온후 "남"인지 판단한다.
		...
		*/
		...
		위와 같이 생략할 수 있으나 가독성이 떨어지므로 매개변수의 타입정도는
		아래와 같이 기술하는것이 좋다.
		...
		*/
		...
		double femalAvg = avg((Human b) -> b.getGender().equals("여"), list1);
		System.out.println("여자 평균:"+ femalAvg);
	}
	/*
