...
//		char chStr = '가나다라'; // 에러발생. 문자열이므로 char로 선언불가능.
		...
		*/
		...
		boolean형 : true 혹은 false 두가지의 값만 가질수 있는 자료형으로
			산수연산(+,-)이나 비교연산(<,<=)에서는 사용할 수 없고 논리연산에서
			사용할 수 있아.
		*/
		boolean bn1 = true;
		boolean bn2 = false;
		...
		*/
		...
		System.out.println("bm3(And)="+ bn3);
