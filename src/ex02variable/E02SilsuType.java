...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		실수자료형
		-정수형보다는 실수형이 더 큰 자료형이다. 0과1 1사이에 무수히 많음
		실수가 존재하기 때문이다.
		...
		*/
		...
		/*
		float와 long의 연산결과를 long으로 받고싶으면...
		...
		*/
		...
		/*
		-실수형에서 기본은 double이다.
		-소수점이 있는 데이터를 컴파일러는 무조건 double로 인신한다.
		-단, 소수점이 없는 데이터는 float에 대입할 수 있다.
		-소수점이 있는 데이터를 float에 대입하려면 접미사 f or F를 붙여야한다.
