...
-단, 기본클래스(String, Integer등)가 아닌 개발자가 새롭게 정의한 클래스라면
	hashCode, equals 메서드를 적절히 오버라이딩하여 재정희 해야한다.
	...
	public static void main(String[] args) {
		...
		*/
		...
		while(itr.hasNext()) {
			...
			/*
			HashSet<E>에 저장시 모든 Object형으로 자동형변환되어 저장되므로
			우리가 직접 정의한 클래스에 대해서만 instanceof를 통해 타입을 확인한후
