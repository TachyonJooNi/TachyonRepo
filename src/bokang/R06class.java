	...
	public static void main(String[] args) {
		...
		체크카드 클래스 Ver.01
			...
			잘못된방법]
				...
				123_456_
				_123_456
				이와같이 언더바로 시작하거나 끝날수 없고, 소수점과 연결해서도
				사용할 수 없다.
		*/
		...
		cc1.balance = 10_000_000;//입급처리없이 잔고의 변경이 가능하다.(논리적오류)
		System.out.println("\n==========================================\n");
		...
		*/
		...
		cc21.charge(5000);//충전
		cc21.showState();//상태확인
//		cc2.balance = 90000000;//정보은닉 되어있으므로 접근불가 에러발생.
		
		/*
		생성자 메서드를 사용하면 객체의 생성과 초기화를 동시에 할수 있으므로
		초기화 메서드보다 편리하다. 즉 객체생성은 생성자를 사용하는것이 좋다.
		*/
		CheckCard2 cc22 = new CheckCard2(9999_8888_7777_6666L, "유비", 40000, 10);
		cc22.payment(5000);
		cc22.showState();
		/*
		...
		*/
		cc22.payment(100000);
		cc22.showState();//마이너스 금액이 출력된다.(논리적오류)
		System.out.println("\n==========================================\n");
