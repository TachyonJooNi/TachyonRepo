...
예를 들어 A=1,000, B=70이라고 하자. 이 경우 노트북을 한 대 생산하는 데는 총 1,070만원이 
들며, 열 대 생산하는 데는 총 1,700만원이 든다.
노트북 가격이 C만원으로 책정되었다고 한다. 일반적으로 생산 대수를 늘려 가다 보면 어느 순간 총수입(판매비용)이 총 
...
public class S02breakevenpoint {
	...
	public static void main(String[] args) {
		...
		int bep; 				//손익분기점
		int fix = sc.nextInt(); //고정
		int var = sc.nextInt(); //가변
		int lap = sc.nextInt(); //노트북 1대가격
	
		bep = fix/(lap-var)+1; 	//문제를 방정식으로 풀고 정리해서 작성
		if(bep<0) {				//손익분기점이 안나오는 음수이면 -1출력하고 종료
